...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="<?php echo path ?>assets/images/favicon.svg" type="image/x-icon">
 <!-- [Font] Family -->
        ...
        <div class="card my-5">
          <div class="card-body">
            ...
            <div class="d-grid mt-4">
                <button type="submit" class="btn btn-primary" value="submit" name="submit">ورود</button>
            </div>
              </form>
          </div>
        </div>
